...
pause
"C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\bin\dumpbin.exe" /linkermember:1 ..\..\lib\wwcommon_d.lib | find "?CreateInstance@?$CFactoryRegistrar" > ..\..\lib\wwcommon_linker.sf1
"C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\bin\dumpbin.exe" /linkermember:1 ..\..\lib\wwcommon_d.lib | find "?RegisterEventType@?$CGameEventRegistrar" >> ..\..\lib\wwcommon_linker.sf1
pause
