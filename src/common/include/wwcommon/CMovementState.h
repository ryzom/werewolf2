...
#ifndef __CMOVEMENTSTATE_H__
#define __CMOVEMENTSTATE_H__
...
class CMovementState : public ISimulationState {
public:
	CMovementState(int direction);
	...
	virtual uint8 getLayerId() {
		return CStateFactory::ST_MOVEMENT;
	}
