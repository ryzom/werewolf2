...
class IMediaController : public WWPROPERTY::IDirtyPropagator {
public:
...
public:
	...
	static void init_script_class() {
		...
		class_<IMediaControllerWrap, boost::noncopyable, bases<WWPROPERTY::IDirtyPropagator> > imcw("IMediaController", no_init);
