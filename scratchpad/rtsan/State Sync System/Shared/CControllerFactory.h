...
public:
	...
	typedef IController* (*CreateController)(CEntity *entity);
	 ...
	 * \param entity The entity this controller will be attached to.
	 *
	 * \return IController pointer to the controller created.
	 */
	IController *createController(std::string name, CEntity *entity);
