...
static bool StringEqual(const string& s1, const string& s2){ return operator==(s1, s2); }
static bool StringNotEqual(const string& s1, const string& s2){ return operator!=(s1, s2); }
static bool StringLeEqual(const string& s1, const string& s2){ return operator<=(s1, s2); }
static bool StringGeEqual(const string& s1, const string& s2){ return operator>=(s1, s2); }
static bool StringLessThan(const string& s1, const string& s2){ return operator<(s1, s2); }
static bool StringGreaterThan(const string& s1, const string& s2){ return operator>(s1, s2); }
...
void RegisterScriptString(asIScriptEngine *engine)
{
	...
	r = engine->RegisterGlobalBehaviour(asBEHAVE_EQUAL,       "bool f(const string &in, const string &in)",    asFUNCTIONPR(StringEqual, (const string &, const string &), bool), asCALL_CDECL); assert( r >= 0 );
	r = engine->RegisterGlobalBehaviour(asBEHAVE_NOTEQUAL,    "bool f(const string &in, const string &in)",    asFUNCTIONPR(StringNotEqual, (const string &, const string &), bool), asCALL_CDECL); assert( r >= 0 );
	r = engine->RegisterGlobalBehaviour(asBEHAVE_LEQUAL,      "bool f(const string &in, const string &in)",    asFUNCTIONPR(StringLeEqual, (const string &, const string &), bool), asCALL_CDECL); assert( r >= 0 );
	r = engine->RegisterGlobalBehaviour(asBEHAVE_GEQUAL,      "bool f(const string &in, const string &in)",    asFUNCTIONPR(StringGeEqual, (const string &, const string &), bool), asCALL_CDECL); assert( r >= 0 );
	r = engine->RegisterGlobalBehaviour(asBEHAVE_LESSTHAN,    "bool f(const string &in, const string &in)",    asFUNCTIONPR(StringLessThan, (const string &, const string &), bool), asCALL_CDECL); assert( r >= 0 );
	r = engine->RegisterGlobalBehaviour(asBEHAVE_GREATERTHAN, "bool f(const string &in, const string &in)",    asFUNCTIONPR(StringGreaterThan, (const string &, const string &), bool), asCALL_CDECL); assert( r >= 0 );
