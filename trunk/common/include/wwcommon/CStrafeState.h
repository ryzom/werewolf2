...
#ifndef __CSTRAFESTATE_H__
#define __CSTRAFESTATE_H__
...
class CStrafeState : public ISimulationState {
public:
	CStrafeState(int direction);
	...
	virtual uint8 getLayerId() {
		return CStateFactory::ST_STRAFE;
	}
